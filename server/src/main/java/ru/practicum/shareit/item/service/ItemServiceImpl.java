...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto updateItem(Long userId, Long itemId, ItemPatchDto itemPatchDto) {
        ...
        // Устанавливаем requestId только если он еще не задан
        if (itemPatchDto.getRequestId() != null && item.getRequest() == null) {
            ItemRequest request = itemRequestRepository.findById(itemPatchDto.getRequestId())
                    .orElseThrow(() -> new NotFoundException("Запрос не найден"));
